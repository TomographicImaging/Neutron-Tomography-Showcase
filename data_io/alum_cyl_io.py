...
from data_io.io import read_mantid_imaging_data, read_angles_from_mi_log_file
...
def read_angles(exposure_time=7.5, roi=None, variant='a'):
    ...
    angles = read_angles_from_mi_log_file(file_path, roi)
...
def read_processed_data(exposure_time, num_angles):
    ...
    return read_mantid_imaging_data(file_path, pixel_size)
