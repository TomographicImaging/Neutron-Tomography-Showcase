...
def run_weighted_fbp_parallel(data, max_gap=None, wedge_behaviour='forward/back'):
    '''
    data: AcquisitionData
        The data to weight and reconstruct.
    ...
    -------
    recon: ImageData
        The data reconstructed with weighted FBP.
    '''
    weights = calculate_angular_sampling_weights_parallel(data, max_gap, wedge_behaviour)
    normalised_weights = normalise_weights_for_FBP(weights)
    recon = run_weighted_fbp(data, normalised_weights)
    return recon
